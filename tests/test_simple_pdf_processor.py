...
from doc_codification.core.simple_pdf_processor import (
    download_pdf,
    extract_text_with_line_numbers,
...
class TestSimplePDFProcessor:
    ...
    def test_download_pdf_success(self):
        ...
        # Mock requests.get
        with patch(
            "doc_codification.core.simple_pdf_processor.requests.get"
        ) as mock_get:
    ...
    def test_extract_text_basic(self, capsys):
        ...
        with patch(
            "doc_codification.core.simple_pdf_processor.pdfplumber.open"
        ) as mock_open:
    ...
    def test_process_pdf_integration(self):
        ...
        with (
            patch(
                "doc_codification.core.simple_pdf_processor.download_pdf"
            ) as mock_download,
            patch(
                "doc_codification.core.simple_pdf_processor.extract_text_with_line_numbers"
            ) as mock_extract,
        ):
